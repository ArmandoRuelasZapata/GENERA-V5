...
abstract class $ItemModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String image, String url});
}
...
class _$ItemModelImpl implements _ItemModel {
  ...
  @override
  String toString() {
    return 'ItemModel(title: $title, image: $image, url: $url)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, title, image, url);
...
abstract class _ItemModel implements ItemModel {
  const factory _ItemModel(
      ...
      required final String url}) = _$ItemModelImpl;
